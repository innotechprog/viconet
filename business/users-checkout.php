		...
		<div class="col-lg-5">
			<div class="white-container tab-content" id="payTab1">
				...
				<?php 
					...
					include "include/payfast2.php";
					echo $htmlForm;					
				 ?>
				 <p>By clicking Pay Now, it shall be deemed that you have read and accept the <a href="">Payment Terms.</a> </p>
			</div>
			...
			<div class="white-container tab-content" id="payTab2">
				...
				<p class="p-10">Account Name: VIRTUAL COLLABORATION NETWORK (PTY) LTD<br>
					Bank:  Nedbank Limited<br>
					Account Number: 1234295466<br>
					Account Type: Current Account<br>
					Branch Code: 198765<br>
					Branch: SBS TRANSACTIONAL (3951)<br>
					Swift code: NEDSZAJJ</p>
					<form method="post" id="invForm">
						<input type="hidden" name="packId" value="<?php echo $package_id ?>">
						<button type="button" class="bton btn2 " id="sendInvoic" style="width:100%">Send invoice</button>
					</form>
					<br>
					<div id="inv-mes"></div>
				 <p class="p-12 mt-2">Kindly use invoice number as reference when doing the payment. Please send proof of payment to: <a href="">Payment Terms.</a> </p>
			</div>
		</div>
	</div>
</div>
