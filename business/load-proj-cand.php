					...
					<div class="white-container">
						<div class="profile-info">
							...
							if($corp->getPackPrice() ==0){
								...
								<label class="p-14 text-black">To be able to view full profile details and invite candidates</label>
							...
							<label class="l-14">Projects</label><label class="p-14-n comp-status" id="numProj" style="background: #FF8EBD"><?php echo $corp->countCompReceipts($corp->getCompReg()); ?></label>
						</div>
						<hr>
						<div class="projects"> 
						<?php
						$query = $corp->getReceipts();
				...
				<div class="col-lg-8">
					...
					<div id="<?php echo $ids ?>" class="corp-edit project-tab">				
						<div class="d-flex justify-content-between">
							...
							<a href="talent-search" class="bton btn2">Add candidates</a>	
						</div>
					<hr>
					...
					<div class="ptabsbg">
						<button class="bton btn4 tab-btn active defaultOpen" onclick="viewCandidate(event,'<?php echo $univited1 ?>')">Uninvited</button>
						<button class="bton btn4 tab-btn" onclick="viewCandidate(event,'<?php echo $pending1 ?>')">Pending</button> 
						<button class="bton btn4 tab-btn" onclick="viewCandidate(event,'<?php echo $accepted1 ?>')">Accepted</button>
						 	<button class="bton btn4 tab-btn" onclick="viewCandidate(event,'<?php echo $declined1 ?>')">Declined</button>
					</div>
					...
					<div id="<?php echo $value ?>" class="tab-content">
						...
						if (substr($value,0,32) == $univited) {
							...
							<button type="button" id="invite" class="bton btn1 mr-0 d-block ml-auto invite">Invite</button>
							</div>
							<?php
							}
							?>
