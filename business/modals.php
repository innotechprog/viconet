			...
			<form method="post" id="addProjForm">
				<div class="row">
					<div class="col-lg-12 form-group">
						...
						<input type="text" class="cust-input" required name="proj_name" placeholder="Enter project name">
						<div class="error-message"></div>
					</div>	 
					<input type="hidden" class="cust-input" name="id" value="projectId">
					<div class="col-lg-12 form-group">
						<label class="input-label">Project Description</label>
						<textarea required rows="3" required class="cust-input" name="proj_desc" placeholder="Enter project description"></textarea>
					</div>
					<div class="col-lg-12 form-group">
						<label class="input-label">External project Description (Visible to talent)</label>
						<textarea required rows="3" class="cust-input" name="ext_proj_desc" placeholder="Enter external project description"></textarea>
					</div>
...
<div id="meetInter" class="modal">
	<div class="edit-modal">
		<div class="live-chat-header">
			<div class="d-flex flex-row justify-content-between">
				<span class="l-18">Meet or interview Talent selected?</span>
				<span ><img src="img/close.svg" class="close"></span>
			</div>
		</div>
		<hr>
		<div class="edit-content">
			<form method="post" id="lastForm">
				<div class="row">
					...
					<div class="col-lg-12">
						<input type="radio" name="eType" value="Interview"><label style="margin-left:10px">Interview</label>
					</div>						
					<div class="col-lg-12 form-group">
...
<div id="addCandidates" class="modal">
	<div class="search-modal col-lg-12">
		<div class="live-chat-header">
			<div class="d-flex flex-row justify-content-between">
				<span class="l-18">Add Talent</span>
				<span ><img src="img/close.svg" class="close"></span>
			</div>
		</div>
		<hr>
<div class="modalSearch">
	...
	<form id="myForm3" method="post" enctype="multipart/form-data"> 
		...
		<div class="" style="margin-top: -15px;">
			...
			<button type="submit" class="bton btn2 search-btn" id="tal_search">Add Talent <label class="comp-status mt-1" style="background: #FF8EBD" id="candAdded">0</label></button>
			</form>
		</div>
			...
			<form method="post" id="myForm" action="save_data">
				...
				<div class="row">
					...
					<div class="col-lg-12 form-group">
						...
						<textarea name="r_desc" required id="about_cand" class="cust-input mendatory_input" style="height:unset;" maxlength="1000" placeholder="Enter Project Description"><?php echo $projectDesc ?></textarea>
					</div>
					<div class="col-lg-12 form-group">
						<label for="ext_proj_desc" class="input-label">External project Description (Visible to talent)</label></label>
						<textarea name="ext_proj_desc" required id="ext_proj_desc" class="cust-input mendatory_input" style="height:unset;" maxlength="1000" placeholder="Enter Project Description"><?php echo $ext_projDesc ?></textarea>
					</div>
