...
$data = array(
    ...
    'return_url' => 'https://business.viconetgroup.com/my-projects?auth='.$auth,
    'cancel_url' => 'https://business.viconetgroup.com/view-basket?auth='.$auth,
    'notify_url' => 'https://business.viconetgroup.com/notify',
    // Buyer details 
    ...
    'custom_str3' => "Recurring",
    'subscription_type'=>1,
    'billing_date'=>$corp->createEndDate($corp->getPackDuration()),
    'recurring_amount'=> $cartTotal,
    'frequency'=>$corp->paymentFrequence($corp->getPackDuration()),
    'cycles'=>0,
