...
?>
		...
		<div class="col-lg-8">
			<div class="white-container">
				...
				if ($count == 0) {
					echo "<div class='col-lg-12'><label class='l-24'>No talent selected </label></div>";	
				}
					?>
				</div>
			</div>
		...
		<div class="col-lg-4">
			<div class="white-container mt-4" style="background: #ECF0F6;border-radius: 0px 0px 15px 15px;">
				<div class="disp-row">
					<div class="l-14">talent shortlisted</div><div class="l-18" style="color:#000" id="num_candidats"></div>
				</div>
				<hr>
				<div class="d-flex justify-content-between">
