...
$ext_projDesc = $_POST['ext_proj_desc'];
$status= "not paid";
...
if($receipt_id)
{
$corp->addToReceipt($receipt_id,$comp_reg,$userEmail,$status,$projName,$projDesc,$ext_projDesc,$date);
...
else if($accessId =="edtp")
{
	...
	$ext_projDesc = $_POST['ext_proj_desc'];
	$corp->updateProject($receipt_id,$receiptName,$receiptDesc,$ext_projDesc);
?>
	<script type="text/javascript">window.location="project?id=<?php echo $receipt_id ?>"</script>
	<?php
}
