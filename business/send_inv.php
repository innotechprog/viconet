...
$email = $corp->getUserEmail();
$encrEmail = md5($corp->getUserEmail());
$name = $corp->getUserName();
$surname = $corp->getUserSurname();
$date = date('d-m-Y');
 $corp->compPackage($pack_id);
 $corp->getAddressBy($encrEmail);
$companyName = $corp->getCompName();
$inv_id = $corp->generateInvoice();
$status = "unpaid"; 
$amount = $corp->getTotPrice();
$corp->addInvoice($inv_id,$email,$amount,$date,$status);
$mail = new PHPMailer(true);
         try {
             ...
             $mail->addAddress($corp->getUserEmail());
                              ...
                              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="width: 100% !important; min-width: 100%; max-width: 100%;">
                                 ...
                                 <tr>
                                    <td align="left" valign="top">
                                       ...
                                       <font face="Quicksand, sans-serif" color="#000000" style="font-size: 20px; line-height: 28px;">
                                          <span style="font-family: Quicksand, Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 16px; line-height: 28px;">'.$inv_id.' <b style="color:red">[UNPAID]</b></span>
                                       </font>
         ...
         <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <table border="0" cellspacing="0" cellpadding="0">
                           <tr><td align="center" valign="top" width="309"><![endif]-->
                           <div style="display: inline-block; vertical-align: top; width: 100%; min-width: 296px;">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="width: 100% !important; min-width: 100%; max-width: 100%;">
                                 <tr>
                                    <td align="left" valign="top" style="border-width: 1px; border-style: solid; border-color: #e8e8e8; border-top: none; border-left: none; border-right: none;">
                                       <font face="ex, sans-serif" color="#000000" style="font-size: 20px; line-height: 28px; font-weight: 600;">
                                          <span style="font-family: Quicksand, Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 16px; line-height: 28px; font-weight: 600;">Banking Details</span>
                                       </font>
                                       <div style="height: 10px; line-height: 10px; font-size: 8px;">&nbsp;</div>
                                   </td>
                                 </tr>
                                 <tr>
                                    <td align="left" valign="top">
                                      <div style="height: 12px; line-height: 12px; font-size: 10px;">&nbsp;</div>
                                      <p> <font face="Quicksand, sans-serif" color="#000000" style="font-size: 20px; line-height: 28px;"> <span style="font-family: Quicksand, Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 16px; line-height: 20px;"><b>Account Name:</b> VIRTUAL COLLABORATION NETWORK (PTY) LTD</span></font></p>
                                       <p><font face="Quicksand, sans-serif" color="#000000" style="font-size: 20px; line-height: 28px;"><span style="font-family: Quicksand, Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 16px; line-height: 20px;"><b>Bank:</b> Nedbank Limited<br>
                                         <b>Account Number:</b> 1234295466</span></font></p>
<p><font face="Quicksand, sans-serif" color="#000000" style="font-size: 20px; line-height: 28px;"><span style="font-family: Quicksand, Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 16px; line-height: 20px;"><b>Account Type:</b> Current Account <br>
   <b>Branch Code:</b> 198765 <br><b>Branch name: </b>SBS TRANSACTIONAL (3951)<br><b>Swift code:</b> NEDSZAJJ
