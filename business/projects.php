				...
				<div class="col-lg-4">
					<div class="white-container">
						...
						<div class="d-flex flex-row justify-content-between">
							<label class="l-14">My Projects</label><label class="p-14-n comp-status" id="numProj" style="background: #FF8EBD"><?php echo $corp->countReceiptsPerUser(md5($corp->getUserEmail())); ?></label>
				...
				<div class="col-lg-8">
					...
					<div id="<?php echo $ids ?>" class="corp-edit project-tab">				
						<div class="d-flex justify-content-between">
							...
							<a href="talent-search?id=<?php echo $ids ?>" class="bton btn2">Add candidates</a>	
						</div>
					<hr>
					...
					<div class="ptabsbg">
						<button class="bton btn4 tab-btn defaultOpen" onclick="viewCandidate(event,'<?php echo $univited1 ?>')" id="<?php echo $btnId ?>">Uninvited</button>
