				...
				<div class="white-container">
					<div class="profile-info">
						...
						<div class="personal-info">
							...
							{
								?>
							<img src="http://<?php echo $web->getWebLinkExt() ?>talent.viconetgroup.com/img/<?php echo $candidate->getPP() ?>" class="prof-pic">
							<?php
							}
							else{
								?>
						...
						<form method="post" id="myForm">
							...
							<input type="hidden" name="cand_num" value="<?php echo $num ?>"><?php if($corp->checkCandidateAdded($candidate->getCandEmail())>0){
								...
								<?php
									...
									?>
									<button class="bton btn2" type="button" id="shortlist_cand" data_id="<?php echo $candidate->getCandID() ?>" style="width:100%">Add to shortlist</button>
									<?php
								}
								?>						
