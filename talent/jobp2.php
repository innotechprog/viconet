					...
					<div class="profile-info">
						<div class="personal-info">
							...
							<form id="myFormPP" method="post" enctype="multipart/form-data">
								...
								<label class="profile-pic" for="p_pic" title="Click to upload Profile Picture">									
										 <label class="user-initials" for="p_pic" style="color:#000" id="user_ini"> <?php echo substr(strtoupper($candidate->getCandName()),0,1).substr(strtoupper($candidate->getCandSurname()),0,1); ?>										 	
										 </label> 
								 								
									<img class="" id="display_image" src="<?php if(empty($candidate->getPP())){}
									else{
										echo 'img/'.$candidate->getPP();
									}?>">                                 
		                        </label>
		...
		<div class="col-lg-8">
				...
				<div class="row">
						<div class="col-lg-12">
							<div class="d-flex justify-content-between">
								<div class="d-flex">
									...
									<div>
									<label class="l-18-n">About <?php echo $candidate->getCandName().' '.$candidate->getCandSurname() ?>					
									</label>
					...
					<div class="d-flex flex-row justify-content-between">
						...
						<div>
							<label class="l-18-n"><label class="l-18-n">CURRENT ROLE & RESPONSIBILITY</label>
							</label>
							<?php 
						?>
				...
				<div class="col-lg-12">
					<div class="d-flex">
						...
						<div style="width:100%">
						<label class="l-18-n">KEY ROLES</label>
							<?php 
					...
					<div class="col-lg-12">
						...
						<div class="addbtnframe">
						<a href="#"class="modal-open addbton btn2" data-modal = "modal12"><img src="img/addw.svg" class="" >Add More</a>
					</div>
						<hr>
					</div>
					<div class="col-lg-12">
					...
					?>
							...
							<div>
								<a href="#"class="modal-open" data-modal = "modal14"><img src="img/add.svg" class="edit-tab" style="margin-right: -7px;"></a>
							</div>
						</div>						
					</div>
					<div class="addbtnframe">
					...
					<div class="col-lg-6">
						...
						{
							?>
							<a href="#" class="modal-open" data-modal = "modal11">
						...
						<a href="cv/<?php echo $candidate->getPdfCV() ?>" class="d-flex">
							...
							<div class=""><label class="l-18-n text-white" style="margin: 10px 10px">Download CV</label></div>
						</a>
							<div class="edit-tab2">
								<a href="#" class="modal-open" data-modal = "modal11"><img src="img/edit-text.svg" class=""></a>
							</div>
						</div>
						<?php
						}
					...
					<div class="col-lg-6">
						...
						<a href="#" class="modal-open" data-modal = "modal18">
							<div class="person-frame d-flex" style="background: #8888d8">
								...
								<div class=""><label for="download_vcv" class="l-18-n text-white" style="margin: 10px 10px">Upload Video CV</label></div>
								<div class="edit-tab2">
									<img src="img/edit-text.svg" class="">
								</div>
							</div>
						...
						<div class="person-frame d-flex" style="background: #8888d8">
							...
							<div>
								<img src="img/downloading-1.svg" id="download_vcv"></a>
							</div>
							<div class=""><label for="download_vcv" class="l-18-n text-white" style="margin: 10px 10px">Download Video CV</label></div>
						    </a>
							<div class="edit-tab2">
								<a href="#" class="modal-open" data-modal = "modal18"><img src="img/edit-text.svg" class=""></a>
							</div>
						</div>
						<?php
						}
...
<div id="modal7" class="modal">
	<div class="edit-modal" style="max-height: unset">
		...
		<div class="edit-content " style="max-height: 100vh;">
			...
			<form method="post" id="myForm" enctype="multipart/form-data">
				<div class="upload-frame1">
					...
					<div class="upload-frame">
						...
						<input type="file" id="long_cv" accept="video/*" name="video_cv" onchange="getFileData(this)">
					</div>
					<div class="d-flex flex-row justify-content-between">
					<span class="l-14 upload-filename" id="pp-name"></span>
					<span ><img src="img/delete.svg" class="delete-upload"></span>
			...
			<form method="post">
				<div class="row">
					...
					<div class="col-lg-12 form-group">
						...
						<input type="date" name="start_date" value="<?php echo $candidate->getCurStartDate()?>" class="cust-input " >
					</div>					
					<div class="col-lg-12 form-group">
		...
		<div class="edit-content">
			<form method="post">
				<div class="row">
					...
					<div class="col-lg-6 form-group">
						<label class="input-label">Endd Date</label>
		...
		<div class="edit-content">
			...
			<div class="row">
				...
				<div class="col-lg-12 form-group">
					...
					<input type="year" name="dateCompleted" required class="cust-input " >
				</div>
