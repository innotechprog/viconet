...
while($rows=$query->fetch())
{
   echo  '<div class="row"><div class="col-lg-12 form-group">
				...
				<div class="col-lg-12 form-group">
					...
					<input type="number" name="dateCompleted" class="cust-input "value="'.$rows['qw_date_completed'].'" >
				</div>
...
while($rows=$query->fetch())
{
   echo  '<div class="row">
					<div class="col-lg-12 form-group">
						...
						<input type="text" name="company_name" class="cust-input " required value="'.$rows['company_name'].'">
					</div>
					<div class="col-lg-12 form-group">
						<label class="input-label">Job Title</label>
						<input type="text" name="job_title" class="cust-input " required value="'.$rows['job_title'].'">
					</div>
					<div class="col-lg-6 form-group">
						<label class="input-label">Starting Date</label>
						<input type="date" name="start_date" class="cust-input " required value="'.$rows['starting_date'].'" >
					</div>
					<div class="col-lg-6 form-group">
						<label class="input-label">End Date</label>
						<input type="date" name="end_date" class="cust-input " required value="'.$rows['end_date'].'">
					</div>				

	           <input  type="hidden" name="experience_id" class="form-control" required value="'.$id.'"><br>';
