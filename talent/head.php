<head>
  ...
  <title>Vico.net | Virtual Collaboration Network</title>
  ...
  <!-- cookie end --> 
  <!-- tables -->
   <link type="text/css" rel="stylesheet" href="portal/assets/plugins/datatables/jquery.dataTables.min.css">
   <link type="text/css" rel="stylesheet" href="portal/assets/plugins/datatables/extensions/dataTables.jqueryui.min.css">
   <!-- End tables -->
  <script src="js/jquery-3.4.1.min.js"></script>
  
  <!-- Template Main CSS File -->
  <link href="css/style.css" rel="stylesheet">
  <link href="css/jobs-style.css" rel="stylesheet">
