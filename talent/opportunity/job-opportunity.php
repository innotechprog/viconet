...
<head>
  <meta charset="utf-8">
    ...
    <title>Vico.net | Opportunity pipeline</title>
			...
			<div class="col-12 ps-lg-5 mt-4 mt-lg-0 mt-md-3 offset-md-0 mt-sm-0 order-md-1">
				<div class="d-lg-block   d-none head-nav-logo">
					<div class="row align-items-start d-lg-flex   d-none pb-lg-5">
						<div class="col align-self-center">
							<a href="index"><img src="img/lazyload-ph.png" data-src="img/back.svg" class="img-fluid mx-auto d-block img-style ms-lg-0 me-lg-0 me-md-1 ms-md-1 lazyload" alt="back" width="44" height="42"></a>
						</div>
						<div class="col text-lg-end head-nav-logo align-self-center">
				...
				<div class="ps-lg-4 pe-lg-4">
					...
					<div class="mt-lg-5">
						<p class="p-16">Are you a graduate seeking work experience?.<br><br>A multinational telecommunications company has a nation-wide graduate training opportunity in 2024 for candidates with STEM related qualifications.<br><br>If interested, please complete this form and follow the prompts! Further information will be provided during the application process.</p>
						<form method="post" action="messages">
							<div class="d-flex">
							<div class="form-group" style="width:80%!important;margin-right:5px">
							<input type="" name="user_email" placeholder="Enter your email" id="user_email" oninput="checkEmail()" class="form-control cust-input"  style="width:100%;margin-right: 5px;">
							<input type="hidden" name="job_id" value="job-3">
							<div class="error-message"></div>
							</div>
							<button type="submit" class="bton btn1 ml-3" id="login_btn">Apply now</button>
						</div>
					</form>
				...
				<div class="ps-lg-4 pe-lg-4">
					<h5 class="h1-style mb-md-5 mt-md-4 mt-sm-4 mb-4 mt-0 mb-lg-0">
						Business Intelligence Reporting & Analytics Specialist
					</h5>
					<div class="mt-lg-5">
						<p class="p-16">TA & Badira is a management and human capital consulting enterprise.<br><br>Our client has a 12-month contract opportunity for 3x Business Intelligence Reporting & Analytics Specialist.<br><br>If you have 3 or more years’ experience as a BI Analyst or Business Analyst, we would like to hear from you. The opportunity is effective immediately and is Gauteng based.<br><br>If interested, please complete this form and follow the prompts! Further information will be provided during the application process.</p>
						<form method="post" action="messages">
							<div class="d-flex">
							<div class="form-group" style="width:80%!important;margin-right:5px">
							<input type="" name="user_email" id="user_email" placeholder="Enter your email" oninput="checkEmail()" class="form-control cust-input"  style="width:100%;margin-right: 5px;">
				...
				<div class="ps-lg-4 pe-lg-4">
					<h5 class="h1-style mb-md-5 mt-md-4 mt-sm-4 mb-4 mt-0 mb-lg-0">
						Workplace Experience for University Students.
					</h5>
					<div class="mt-lg-5">
						<p class="p-16">A multinational telecommunications company has limited career opportunities offering experiential learning to University students who require workplace experience to complete their tertiary qualification or degree.<br><br>The opportunity is primarily Gauteng based and it is envisaged to commence in November 2023<br><br>If interested, please complete this form and follow the prompts! Further information will be provided during the application process.</p>
						<form method="post" action="messages">
							<div class="d-flex">
							<div class="form-group" style="width:80%!important;margin-right:5px">
							<input type="" name="user_email" placeholder="Enter your email" id="user_email" oninput="checkEmail()" class="form-control cust-input"  style="width:100%;margin-right: 5px;">
...
<script type="text/javascript" src="js/email-val.js"></script>
