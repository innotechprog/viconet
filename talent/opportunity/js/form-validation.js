...
if (name2.value.length  === 0) {
	...
	errors(name2,'Name canot be empty');
}
return false;
}
...
if(checkName() == true && checkSurname() == true && checkEmail()==true &&  checkPassword()== true && checkConfirmPassword()==true && checkConsent()==true && checkTermsAndCond()==true){
