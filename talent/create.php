<?php
session_start();
$cookie_domain = '.viconetgroup.com';
...
$redirectUri = 'https://talent.viconetgroup.com/callback.php';
            ...
            <div class="col-12 ps-lg-5 mt-4 mt-lg-0 mt-md-3 offset-md-0 mt-sm-0 order-md-1">
                ...
                <div class="ps-lg-4 pe-lg-4 scrollable pb-lg-5">
                    <h5 class="h1-style mb-md-5 mt-md-4 mt-sm-4 mb-4 mt-0 mb-lg-4 mt-lg-5">
                       Hi <?php echo $candidate->getCandName() ?>
                    </h5>
                    <p class="p-style">Please create your password for the email below to access your profile</p>
    
                    <div class="mt-lg-0">
                        <form name="myForm" id="updateForm" action="update_candidate" method="post"enctype="multipart/form-data">
                            <div class="row">  
                            <div class="offset-0 col-12 col-sm-6 offset-lg-0 col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control text-fl cust-input" type="text" disabled value="<?php echo $candidate->getCandEmail() ?>">
                            ...
                            <div class="offset-lg-0 col-lg-12">
                                ...
                                <div class="p-style form-check ">
                                    ...
                                    <label class="form-check-label">
                                        I accept <a href="legal documents/CANDIDATE TERMS.pdf" class="a-link">terms and condition</a>
                                    </label> 
                                    <div class="error-message"></div>
                                </div>
                            </div>
                            <div class="col">
                                <button class="btn btn-d w-100 btn-lg mb-md-2 mb-sm-2 btn-12 mb-lg-0 btn-before" style="" type="submit" id="submit_changes">Complete Profile</button>
                        ...
                        <form name="myForm" id="myForm" method="post" enctype="multipart/form-data">
                            ...
                            <div class="offset-0 col-12 col-sm-6 offset-lg-0 col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control text-fl cust-input" type="email" data-error-validation-msg="Not a valid email address" name="userEmail" id="userEmail" oninput="checkEmail()" value="<?php if(isset($_SESSION['oppo_c_email'])){ echo $_SESSION['oppo_c_email']; } ?>">
                                    <div class="error-message"></div>
                            ...
                            <div class="offset-lg-0 col-lg-12">
                                ...
                                <div class="p-style form-check ">
                                    <input class="form-check-input mb-lg-4 mb-md-3 mb-sm-3 mb-4" type="checkbox" id="userT_and_c" name="userT_and_c">
                                    <label class="form-check-label">
                                        I accept <a href="legal documents/CANDIDATE TERMS.pdf" class="a-link" target="_blank">terms and condition</a>
                                    </label> 
                                    <div class="error-message"></div>
                                </div>
                            </div>
                            <div class="col">
                                <button class="btn btn-d w-100 btn-lg mb-md-2 mb-sm-2 btn-12 mb-lg-0 btn-before" style="" data-bs-toggle="modal" type="button" id="add_candidate">Create</button>
...
if(isset($_GET['access'])){
?>
<script type="text/javascript" src="js/verify-acc-val.js"></script>
<?php  
}
else{
    ?>
