				...
				<div class="card-f">
					<div class="row">
						<div class="col align-self-center">
							<img src="img/lazyload-ph.png" data-src="img/back.svg" class="img-fluid float-lg-none lazyload" alt="back" width="44" height="42">
						</div>
						<div class="col align-self-center">
							<img src="img/lazyload-ph.png" data-src="img/logo.svg" class="img-fluid float-lg-end lazyload" alt="logo" width="179" height="66">
						</div>
					</div>
					<div class="row" id="reset_pas">
						<div class="col mt-lg-3">
							...
							<div class="form-group mb-3">
								...
								<input class="form-control text-fl mb-4" name="email" type="email" data-error-validation-msg="Not a valid email address">
								<input type="hidden" name="type" value="<?php echo $_GET['t'] ?>">
								<button type="button" name="reset_pass" id="reset_pass" class="btn btn-d w-100 btn-lg mb-md-2 mb-sm-2 mt-lg-4 btn-12">Submit</button>
							</div>
							</form>
						</div>
					</div>
						<div class="row" id="reset_mes" style="display: none;">
					<div class="row">
						<div class="col align-self-center">
							<div class="row">
								<div class="col">
									...
									<p style="white-space:inherit;" class="p-style  mb-md-4 mb-4 text-lg-center mt-lg-0 mt-md-0 float-md-none text-md-center text-sm-center mt-sm-0 text-center mt-0 ">
										<strong >Password reset link has been sent to your email, please check</strong>
									</p>
								</div>
							</div><a href="index" class="btn btn-d btn-lg mb-md-2 mb-sm-2 btn-12 float-lg-none mt-lg-0 w-100">Home</a>
						</div>
					</div>
					</div>
				</div>
