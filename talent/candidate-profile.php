				...
				<div class="white-container">
					<div class="profile-info">
						...
						<div class="personal-info">
							...
							<p class="p-14-n"><?php echo substr($corp->getHidden($candidate->getAddress()),1,30) ?></p>
						...
						<?php if($corp->getPackPrice() != 0)
				{
					?>
						<div class="person-frame" style="background: #7878DA;display: flex;">
							<div>
								<a href="cv/<?php echo $candidate->getPdfCV() ?>" target="_blank" id="pdf_cv"><img src="img/pdf2.svg"></a>
							</div>
		...
		<div class="col-lg-8">
				...
				<div class="row">
					...
					<div class="col-lg-12">
					  ...
					  <source src="video cv/<?php echo $candidate->getVideoCV() ?>">
					</video>
					</div>
					<?php
					}
